  ...
  return (
    <>
      <section
        ...
        className="container"
      >
        <div className="px-5 lg:px-35 flex flex-col items-center justify-center h-[400px] bg-[linear-gradient(0deg,rgba(0,0,0,0.8),rgba(0,0,0,0.8)),url(/images/hero_img.jpg)] bg-cover md:bg-size-[100%_200%] bg-center md:bg-position-[center_-160px] rounded-[10px]">
          <div className="text-light-primary text-center mb-6">
            <h1 className=" text-2xl lg:text-5xl font-poppins font-bold leading-[110%] ">
